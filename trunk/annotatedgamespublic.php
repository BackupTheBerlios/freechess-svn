...
include_once('config.php');
	...
	/* Language selection */
	//require "languages/".$_SESSION['pref_language']."/webchess/strings.inc.php";
?>
<HTML>    
<head>
...
<LINK rel="stylesheet" href="themes/<?=$_SESSION["pref_colortheme"]?>/webchess/styles.css" type="text/css">
</HEAD>
