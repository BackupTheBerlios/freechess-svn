...
<? require_once('header.inc.php');?>
  ...
  <tr>
    ...
    <table border="1" width="100%">
	<tr><th colspan=4><font size=+1>Ranking by Total Team Match Wins</font></th>
	</tr>
	<tr>
	<th>&nbsp;</th>
	<th>Wins</th>
...
<?
	$n=$inicio+1;
	$p = mysql_query("SELECT * from team WHERE wins>0 order by wins DESC");
 	$ratings = array();
