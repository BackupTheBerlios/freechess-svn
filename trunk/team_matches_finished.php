...
<?
	...
	echo "<table border='1'><tr><th colspan='6'><font size=+1>All Finished Matches</font></th></tr>";

	$tgm = mysql_query("SELECT * FROM matches WHERE gameMessage = 'finished'");
	...
	echo "<tr>
	<th><br><a href='stats_team.php?cod=".$tm[team1]."'><b>".$team1."</b></a> vs <a href='stats_team.php?cod=".$tm[team2]."'><b>".$team2."</b></a><br>&nbsp;</th><th><b>Match # ".$tm[match_id]."</b></th><th><b>Result</b></th><th colspan='2'><b>Match Score</b><br>".$team1.":&nbsp;&nbsp;";
	...
	echo "<b>".$kp[match_points2]."</b></font></td></tr>";
...
$result_score = ""; 
if ($row2[0] == "checkMate" AND $row2[1] == "white") $result_score="".$yls." Wins 2 Points"; 
if ($row2[0] == "checkMate" AND $row2[1] == "black") $result_score="".$opt." Wins 2 Points"; 
...
if ($row2[0] == "draw" AND $row2[1] == "black")$result_score="".$opt." Wins 1 Point";
	...
	echo "<table><tr><td>There are currently no completed matches.</td></tr></table>";
