...
var iMaxMoves;
var strImageLoc = "images/pieces/plain/";
...
function WriteButtons()
{
	...
	document.write("<br><bgcolor=white>");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowLeft3.gif\" onclick=\"javascript:MoveFirst();\">");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowLeft2.gif\" onclick=\"javascript:MoveBack(5);\">");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowLeft.gif\" onclick=\"javascript:MoveBack(1);\">");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowRight.gif\" onclick=\"javascript:MoveForward(1);\">");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowRight2.gif\" onclick=\"javascript:MoveForward(5);\">");
	document.write("<input type=\"IMAGE\" src =\"images/3DArrowRight3.gif\" onclick=\"javascript:MoveEnd();\">");
         document.write("<br><input type=\"button\" value=\"Mainmenu\" onclick=\"window.location='mainmenu.php'\">");
	document.write("<input type=\"button\" value=\"W/B\" onclick=\"javascript:SwitchSides();\">");
