...
{
   strImageLoc='images/pieces/plain/';
   for(var i = 0 ; i<8 ; i++)
		{
		board[i] = new Array();
		for (var j = 0; j<8 ; j++)
...
function Piece(iii,jjj)
{
   var x = (iii*8) + jjj + 1;
   var p = board[iii][jjj];
   return("<img width=30 src=\"" + PieceName(p) + "\" id=\"d" + iii.toString() + jjj.toString() + "\" onclick=\"javascript:SquareClick("+iii+","+jjj+");\">");
}
...
function WriteButtons()
{
	...
	document.write("<input type=\"button\" value=\"W/B\" onclick=\"javascript:SwitchSides();\"><br>");
    ...
    document.write("<input type=\"button\" value=\"Analyze\" onclick=\"window.open('analyze.php?whocolor="+who+"&game="+gameID+"','_blank');\">");
}
function StartTable(){

var boardstart_black ="<table><tr><td><table height=240><tr><td align=\"center\">1</td></tr><tr><td align=\"center\">2</td></tr><tr><td align=\"center\">3</td></tr><tr><td align=\"center\">4</td></tr><tr><td align=\"center\">5</td></tr><tr><td align=\"center\">6</td></tr><tr><td align=\"center\">7</td></tr><tr><td align=\"center\">8</td></tr></table></td><td><TABLE BORDER=0><TR><TD><TABLE border=0 width=240 height=240 style=\"background: url(" +strImageLoc + "board.gif);\" border=0 cellspacing=0 cellpadding=0><TR><TD>\n";

var boardstart_white ="<table><tr><td><table height=240><tr><td align=\"center\">8</td></tr><tr><td align=\"center\">7</td></tr><tr><td align=\"center\">6</td></tr><tr><td align=\"center\">5</td></tr><tr><td align=\"center\">4</td></tr><tr><td align=\"center\">3</td></tr><tr><td align=\"center\">2</td></tr><tr><td align=\"center\">1</td></tr></table></td><td><TABLE BORDER=0><TR><TD><TABLE border=0 width=240 height=240 style=\"background: url(" +strImageLoc + "board.gif);\" border=0 cellspacing=0 cellpadding=0><TR><TD>\n";
...
var boardend_white = "</TD></TR></TABLE></TD></TR></TABLE><table width=240><tr><td align=\"center\">A</td><td align=\"center\">B</td><td align=\"center\">C</td><td align=\"center\">D</td><td align=\"center\">E</td><td align=\"center\">F</td><td align=\"center\">G</td><td align=\"center\">H</td></tr></table></td></tr></table>\n";

var boardend_black = "</TD></TR></TABLE></TD></TR></TABLE><table width=240><tr><td align=\"center\">H</td><td align=\"center\">G</td><td align=\"center\">F</td><td align=\"center\">E</td><td align=\"center\">D</td><td align=\"center\">C</td><td align=\"center\">B</td><td align=\"center\">A</td></tr></table></td></tr></table>\n";
...
function SwitchSides()
{
         ...
         {
         who="black";
         location = 'forum_analyze.php?whocolor=black&game='+gameID;
         }
         else
         {
         who="white";
         location = 'forum_analyze.php?whocolor=white&game='+gameID;
         };
