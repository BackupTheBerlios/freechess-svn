...
<?
    ...
    */
	...
	if ($chess_bot_id>0)
		$p1 = mysql_query("select * from players WHERE ativo='1' AND engine='1' AND playerID='$chess_bot_id'");
	else
    	$p1 = mysql_query("select * from players WHERE ativo='1' AND engine='1' ORDER BY engine_flag");
    ...
    while($row = mysql_fetch_array($p)){
	    ...
	    while (TRUE){
		  ...
		  if ($PLY <2){
 		  ...
 		  echo "$now # $JOGADOR_NAME Trying again.\n";
	    }
