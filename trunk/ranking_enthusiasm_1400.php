...
$tempo = time()-604800;
$rs = mysql_query("SELECT playerID,lastUpdate from players where lastUpdate>='$tempo' and ativo<>'0' and rating <= 1400 and rating>=900 and pontos>0 order by pontos DESC $limit");
...
<?
    ...
    $n=1;
	$p=mysql_query("SELECT rating_month,firstName,playerID,rating_max,pontos,rating,lastUpdate from players where lastUpdate>='$tempo' rating <= 1400 and rating>=900 ativo<>'0' order by pontos DESC limit,rating_month DESC $CFG_RANKING_LIMIT");
...
$p = mysql_query("SELECT rating,firstName,playerID,rating_max,pontos,lastUpdate from players where lastUpdate>='$tempo' and ativo<>'0' and
		 rating <= 1400 and rating>=900 and pontos>0 order by pontos DESC,rating_month DESC limit $inicio,$perpage");
