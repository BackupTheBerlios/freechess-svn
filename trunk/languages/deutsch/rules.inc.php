...
<BR><font face="Verdana" size="2"><center><b>DAS HILFESYSTEM AUF CHESSMANIAC.COM</b><br><font face="Verdana" size="1">Version 0.1 vom 19.12.2004<br></font>
...
<li><a name="obenb1"><a href="#zugrueck">Zugrückgabe</a></li>
<li>Turniere</li>
<li><a name="oben"><a href="#pt">Preisturniere</a></li>

<br>
<b>Neue Partie erstellen</b><br>
<li><a name="obena1"><a href="#standard">Reguläre Partien</a></li>
<li><a name="obena1"><a href="#blitz">Blitzpartien</a></li>


<br>
<b>Einstellungen</b><br>
<li><a name="oben"><a href="#pdaten">Persönliche Daten ändern</a></li>
<li>Design ändern</li>
<li><a name="oben"><a href="#figuren">Spielfiguren ändern</a></li>
...
<li><a name="oben"><a href="#account">Account löschen</a></li>
...
<br>
- Auf PSM Schach gelten die allgemeinen <a href="http://www.ilo.de/schachkreis/fidereg.htm" target="_blank">Schachregeln</a>. Sollten aus programmtechnischen Gründen Abweichungen notwendig werden, entscheidet der zuständige <a href="mailto:schach@zum.de">Webmaster.</a><br>
- Alle Spieler beginnen mit einer Bewertung von 1500 Punkten. <br>
- Herausforderungen, die nicht angenommen wurden, werden automatisch nach <?=$CFG_EXPIREGAME?> Tagen gelöscht.<BR>
- Spiele mit weniger als <?=$CFG_MIN_ROUNDS?> Zügen werden nicht gewertet.<BR>
- Auf PSM Schach gelten die üblichen Schachregeln! Diese Plattform bietet eine Reihe von Funktionen, dennoch sollten Sie berücksichtigen, dass sich das Programm in der Entwicklung befindet; es handelt sich um Opensource-Software, die von interessierten Spielern in ihrer Freizeit entwickelt wird. Wenn Sie sich daran beteiligen möchten, klicken Sie <a href="http://compwebchess.com/forums/" target="_blank">hier</a>!<br>
- Alle Spieler sind angehalten, gegenüber Mitspielern den guten Ton zu wahren. Beleidigungen, Beschimpfungen sowie obszöne, vulgäre, rassistische oder sexistische Äußerungen sind strengstens untersagt und führen zum sofortigen Ausschluss des Spielers sowie der Sperrung seines Accounts.<br>
...
<b>ZUGRÜCKGABE</b>
<br><br>
- Partien, in denen während <?=$CFG_EXPIREGAME?> Tagen kein Zug erfolgte, werden automatisch für den ziehenden Spieler als "Verloren wegen
Zeitüberschreitung" gewertet. <br>
- Die standardmäßige Zugrückgabe von <?=$CFG_EXPIREGAME?> Tagen kann in regulären sowie in Turnierspielen mithilfe eines Menüs tageweise reduziert werden.  

<br>
<br><center><img src="images/help/zugrrueck2.JPG"></center>
<br>

- Ob die Zugrückgabe in einem Spiel früher erfolgen muss, erkennen Sie <br>
...
<br><br>
Hinweise: Die Schachuhr bezieht sich auf die insgesamt verbrauchte Spielzeit. Bitte orientieren Sie sich bei der eingeschränkten Zugrückgabe anhand der Zeitangabe "Lezter Zug" auf der Übersichtsseite.<br>
Als Mitglied haben Sie <?=$CFG_EXPIREGAME?> Tage Zeit für die Zugrückgabe. Wir bitten jedoch darum, nur in absoluten Ausnahmefällen (Urlaub oder Abwesenheit) von dem Zeitlimit Gebrauch zu machen. In der Regel sollten Sie innerhalb von 24-48 Stunden einen gegnerischen Zug erwidern. <br>
...
In unregelmäßigen Abständen finden auf PSM Schach Preisturniere statt. Zu gewinnen gibt es i.d.R. Software, die von Sponsoren zur Verfügung gestellt wird. Grundsätzlich gilt bei allen Preisturnieren: Sollte es auf irgendwelchen (v.a. technischen ) Gründen zu Problemen bei der Feststellung der Sieger kommen, werden die Preise verlost. Der Rechtsweg ist ausgeschlossen.
<br><br>
...
<br><br><a name="standard"><b>REGULÄRE PARTIEN</b><br><BR><br>
Es gibt verschiedene Möglichkeiten, Partien zu erstellen. Über den Button "Neue Partie" erreichen Sie die entsprechenden Formulare. Laden Sie einen Gegner direkt ein oder erstellen Sie eine Partie, die ein beliebiger User annehmen kann. Alternativ können Sie auch gegen einen Computergegner (BOT) spielen. Wenn Sie sich neu registriert haben, können Sie nur Minotaur fordern. 
<br><br>

<br><center><img src="images/help/voreinstellungen.JPG"><br>Wählen Sie zunächst <br>die gewünschten Voreinstellungen. </center><br><br><br>
...
Die Blitzpartien können optional mit bzw. ohne Wertung gespielt werden; d.h. sie müssen nicht zwingend in die ELO-Ranglistenpunkte der regulären Spiele eingerechnet werden.<br>
Jede angebotene Blitzpartie, die nicht innerhalb einer Stunde von einem Gegner angenommen wurde, wird ebenfalls nach einer Stunde automatisch gelöscht. Bitte beachten Sie: PSM Schach ist kein Echtzeitschacht. Durch den notwendigen Refresh der Seite kann es zu Verzögerungen in Ihrer Partie kommen. Wählen Sie - um sicher zu gehen - möglichst eine ausreichende Zeit für die Blitzpartie. (30 min. ist sehr knapp und erfordert, dass Sie die Seite manuell (Button: Neu laden) refreshen, um auf mögliche Züge schnell zu reagieren.
<br>
Es gibt eine separate Rangliste für Blitzpartien. Für eine gewonnene Partie erhalten Sie zwei Punkte, für ein Remis einen Punkt! <br>
...
<br><br><a name="pdaten"><b>PERSÖNLICHE DATEN ÄNDERN</b><br><BR><br>
Über den Button "Einstellungen" im Menü können Sie Ihre persönlichen Daten ändern. Das beinhaltet im Moment <br>
a) den Benutzernamen (also der Nick, mit dem Sie sich einloggen)<br>
b) Ihren Wohnort und Ihr Land<br>
c) Ihr Passwort. <br><br>
Bitte berücksichtigen Sie, dass Sie bei jeder Änderung 3x Passwörter eingegeben müssen. <br><br>
Beispiel: Sie wollen Ihren Wohnort ändern, aber ihr altes Passwort behalten: Geben Sie Ihren neuen Wohnort und 3x ihr altes Passwort (1x als neues Passwort).<br>
Beispiel2: Sie wollen Ihr Passwort ändern: Geben Sie 2x Ihr altes Passwort ein und beim dritten Mal das neue Passwort.
<br>
<br>
In begründeten Fällen kann der Spielername geändert werden. Kontaktieren Sie hierfür den <a href="mailto:schach@zum.de">Webmaster</a>. Teilen Sie bitte auch mit, wenn sich Ihre E-Mail Anschrift ändern sollte, damit der den Eintrag korrigiert werden kann. <br>
Die restriktive Handhabung der persönlichen Daten dient allein Ihrem Schutz. Standardmäßig erlaubt <a href="http://kymera.comp.pucpcaldas.br/projetos/compwebchess/" target="_blank">Compwebchess</a> den Spielern einen beliebigen Wechsel der Namen und unterbindet noch nicht einmal Doupletten. Es ist leicht vorstellbar, welche Verwirrung damit ausgelöst werden kann.
<br><br>
...
<br><br><a name="figuren"><b>SPIELFIGUREN ÄNDERN</b><br><BR><br>
Bitte ändern Sie die Default-Einstellung (Beholder) ggf. unter dem Button "Einstellungen". Folgende Schachfiguren stehen auf PSM Schach zur Verfügung. Wir empfehlen Beholder oder Fun.
<br><br>
<table border="0">
...
PSM Schach bietet die Möglichkeit, den letzten Zug farblich hervorzuheben. Sie können unter "Einstellungen => Letzten Zug markieren" verschiedene Farben wählen. Sollte Sie die Einblendung zu sehr ablenken, können Sie sie unter "Einstellungen => Letzten Zug markieren" deaktivieren.
...
PSM Schach bietet die Möglichkeit, dass Spieler sich über Einladungen oder gegnerische Züge per E-Mail informieren lassen. Diese Funktion (Klick auf "Einstellungen => scroll down) ist standardmäßig deaktiviert. Sollten Sie zahlreiche Spiele haben und täglich auf PSM Schach online sein, ist es ohnehin nicht sinnvoll, sie zu aktivieren.
<br><br>



<br><center><img src="images/help/benachrichtigung.JPG"><br>Tragen Sie Ihre E-Mail ein, um sich <br>über Einladungen oder gegnerische Züge informieren zu lassen.</center><br>
...
PSM Schach verfügt über ein internes Mailsystem. Sie können einem Mitspieler eine private Nachricht senden. Die Benachrichtigung erfolgt über eine Einblendung auf der Übersichts-Seite (mainmenu); optional können Sie sich auch per E-Mail benachrichtigen lassen.
<br><br>
Um eine private Nachricht zu versenden, klicken Sie bitte auch den gleichnamigen Button in der Navigation und dann auf den Link "Hier klicken, um eine Private Nachricht zu verschicken!". Bitte berücksichtigen Sie, dass Ihr Browser zwingend Popups unterstützen muss. 
...
<p>Das Elo-System ist ein Wertungssystem, das ein Maß
für die Spielstärke der Spieler geben soll. Durch die
Elo-Zahlen ist eine Klassifizierung aller Schachspieler möglich
und die Spielstärke (annähernd) feststellbar.</p>

<p>Im Jahre 1970 wurde das von <b>Arpad Elo</b> (1903-1992),
einem aus Ungarn stammenden Professor für Theoretische Physik
an der Universität Milwaukee, ausgearbeitete Koeffizientensystem
...
aufgebaut und heute international gebräuchlich.</p>
...
die Änderung seiner Elo-Zahl ermitteln. Man braucht dazu
außer der nachstehenden <a href="#tabe">&#8595;&nbsp;Tabelle</a>
oder der entsprechenden <a href="#form">&#8595;&nbsp;Formel</a>
folgende drei Daten:</p>

<pre><p class="tabw">1) Elo(eigene, alt)   zuletzt veröffentlichte Elo-Zahl
...
<p>Jede Partie wird für sich bewertet und hat außer
der hier berechneten Änderung keinen weiteren Einfluss
auf die Elo-Zahl.</p>
...
<p>Hinweis: Das ELO-System auf PSM Schach wurde von dem User Winterfrost implementiert. Herzlichen Dank an dieser Stelle. Grundlage für
...
<i>Jeder Spieler auf dem ersten Rang erhält diese Medaille</i>
<br><br>
<u>Pour le Merite</u><br>
<i>Der Merite-Orden wird folgendermaßen vergeben:</i><br><br>
<img src="images/rank/merit100.gif"> = Merite100<br>
Dieser Orden ist für Spieler, die 100 und mehr Spiele <br>mit einer Prozentzahl von über 90 Siegen gespielt haben.<br><br>
<img src="images/rank/merit50.gif"> = Merite50<br>
Dieser Orden ist für Spieler, die 50 und mehr Spiele <br>mit einer Prozentzahl von über 90 Siegen gespielt haben.<br><br>
<img src="images/rank/merit20.gif"> = Merite20<br>
Dieser Orden ist für Spieler, die 20 und mehr Spiele <br>mit einer Prozentzahl von über 90 Siegen gespielt haben.<br><br>

<u>Courage</u><br>
<i>Den Courage-Orden erhält der Spieler, der an einem Tag 10 oder mehr Spiele beginnt und </i>
<br><br>
...
<br>
<p>Leiter einer Schach-AG können auf Wunsch erweiterte Gruppenberechtigungen erhalten. <br>
a) Es können mehrere Gruppen angelegt werden.
b) Es können Spieler zwischen den jeweiligen Gruppen verschoben werden.
<br>

Kontaktieren Sie für diese Funktion bitte den <a href="mailto:schach@zum.de">Webmaster</a>.
<br><br>
<p><a href="#oben">nach oben</a></p>
...
- Auf PSM Schach können Sie jede Partie kommentieren. Sie haben dazu zwei Möglichkeiten:<br>
1) Sie entscheiden sich für eine klassische Annotation. Drücken Sie oberhalb des Spielverlaufs den Button Spielanalyse und benutzen Sie das Analysebrett um einzelne Züge zu kommentieren. Diese Funktion muss durch den Webmaster für Sie freigeschaltet werden. <br>Alle annotierten Partien finden Sie unter dem Button "Annotationen".<br>
...
<br><br>
Jede Partie lässt sich im PGN-Format exportieren oder abspeichern. Drücken Sie oberhalb des Spielverlaufs den Button Spielanalyse. Sie sehen dann das Analysebrett. Unterhalb des Brettes finden Sie den Button "PGN-Export". Klicken Sie darauf und speichern Sie die Partie auf Ihrer Festplatte oder öffnen Sie sie mit einem anderen Programm.

<center><img src="images/help/export.JPG"></center>

<br>
Ein aktuelles PGN-File sämtlicher PSM SCHACH Partien ist für einen Unkostenbeitrag von 15€ (CD 20€, inkl. Versand) erhältlich. Bitte sprechen Sie bei Bedarf den <a href="mailto:schach@zum.de">Webmaster</a> an!
<br><br>
Hinweis: Es ist strengstens untersagt, in Wertungspartien das Ergebnis mit Schachcomputern (sog. Engines) zu manipulieren. Es werden stichprobenartig Kontrollen durchgeführt. <br><br>
...
<br><br>
PSM Schach verpflichtet sich, keine persönlichen Daten von Spielern an dritte Personen weiterzugeben.
<br>
Der gesamte Datenverkehr (Private Nachrichten, persönlicher Chat) kann durch den Webmaster kontrolliert und eingesehen werden. Von dieser Möglichkeit wird i.d.R. kein Gebrauch gemacht. Im Beschwerdefall behält sich PSM Schach jedoch ausdrücklich das Recht vor, Nachrichten und Chatmitteilungen einzusehen.
<br><br>
...
<br><br>
Auf Wunsch kann ein Account deaktiviert werden. Dies bedeutet, dass der User nicht mehr im Spielerverzeichnis sowie im Ranking gelistet wird. Das vollständige Löschen eines Accounts sowie bereits gespielter Partien ist nicht möglich.
...
Das Hilfesystem ist im Aufbau! Haben Sie noch Fragen oder Verbesserungsvorschläge? Möchten Sie selber am Hilfesystem mitarbeiten? Bitte schreiben Sie eine <a href="messages.php">Nachricht</a> an GMondwurf!<br>Ich freue mich über Ihre Beiträge!<br><br>
</font>
</p>
